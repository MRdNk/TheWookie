function sites (pgClient, opts) {
  ...
  function insert(site, cb) {
    ...
    if (site.name === undefined)
      cb('"Site name" not defined')

    if (site.created_by_user_id === undefined)
      cb('"Created by user id" not defined')
    ...
    function runInsert() {
      ...
      if (site.created_by_user_id === '' || site.created_by_user_id === '0' || site.created_by_user_id === undefined) cb('Invalid created_by_user_id')
      else {
